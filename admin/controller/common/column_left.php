...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'measurement/measurement')) {		
				$measurement[] = array(
					'name'	   => $this->language->get('text_measurement'),
					'href'     => $this->url->link('measurement/measurement', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}

			if ($this->user->hasPermission('access', 'measurement/suit')) {		
				$measurement[] = array(
					'name'	   => $this->language->get('text_suit'),
					'href'     => $this->url->link('measurement/suit', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}
			
			if ($this->user->hasPermission('access', 'measurement/pants')) {		
				$measurement[] = array(
					'name'	   => $this->language->get('text_pants'),
					'href'     => $this->url->link('measurement/pants', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}

			if ($this->user->hasPermission('access', 'measurement/shirt')) {		
				$measurement[] = array(
					'name'	   => $this->language->get('text_shirt'),
