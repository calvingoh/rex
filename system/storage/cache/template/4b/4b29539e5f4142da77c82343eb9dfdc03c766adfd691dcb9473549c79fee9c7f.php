...
/* measurement/shirt_list.twig */
class __TwigTemplate_56146e087ab36244d1d99f4dd5abea39278ad08eae62755e5a0983d5dfb4b188 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
      ...
      <div class=\"panel-body\">
        ...
        echo "</td>
              ...
              ";
        // line 53
        if (($context["shirts"] ?? null)) {
            // line 54
            echo "              ";
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(($context["shirts"] ?? null));
            foreach ($context['_seq'] as $context["_key"] => $context["shirt"]) {
                // line 55
                echo "              <tr>
                <td class=\"text-center\">";
                // line 56
                if (twig_in_filter(twig_get_attribute($this->env, $this->source, $context["shirt"], "shirt_id", [], "any", false, false, false, 56), ($context["selected"] ?? null))) {
                    // line 57
                    echo "                  <input type=\"checkbox\" name=\"selected[]\" value=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["shirt"], "shirt_id", [], "any", false, false, false, 57);
                    echo "\" checked=\"checked\" />
                  ";
                } else {
                    // line 59
                    echo "                  <input type=\"checkbox\" name=\"selected[]\" value=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["shirt"], "shirt_id", [], "any", false, false, false, 59);
                    echo "\" />
                  ";
                }
                // line 60
                ...
                <td class=\"text-left\">";
                // line 61
                echo twig_get_attribute($this->env, $this->source, $context["shirt"], "length", [], "any", false, false, false, 61);
                echo "</td>
                <td class=\"text-left\">";
                // line 62
                echo twig_get_attribute($this->env, $this->source, $context["shirt"], "shoulder", [], "any", false, false, false, 62);
                echo "</td>
                <td class=\"text-left\">";
                // line 63
                echo twig_get_attribute($this->env, $this->source, $context["shirt"], "cuff_h", [], "any", false, false, false, 63);
                echo "</td>
                <td class=\"text-left\">";
                // line 64
                echo twig_get_attribute($this->env, $this->source, $context["shirt"], "cuff_o", [], "any", false, false, false, 64);
                echo "</td>
                <td class=\"text-left\">";
                // line 65
                echo twig_get_attribute($this->env, $this->source, $context["shirt"], "chest_f", [], "any", false, false, false, 65);
                echo "</td>
                <td class=\"text-left\">";
                // line 66
                echo twig_get_attribute($this->env, $this->source, $context["shirt"], "chest_b", [], "any", false, false, false, 66);
                echo "</td>
                <td class=\"text-left\">";
                // line 67
                echo twig_get_attribute($this->env, $this->source, $context["shirt"], "hip", [], "any", false, false, false, 67);
                echo "</td>
                <td class=\"text-left\">";
                // line 68
                echo twig_get_attribute($this->env, $this->source, $context["shirt"], "collar", [], "any", false, false, false, 68);
                echo "</td>
                <td class=\"text-left\">";
                // line 69
                echo twig_get_attribute($this->env, $this->source, $context["shirt"], "status", [], "any", false, false, false, 69);
                echo "</td>
                <td class=\"text-left\">";
                // line 70
                echo twig_get_attribute($this->env, $this->source, $context["shirt"], "date_added", [], "any", false, false, false, 70);
                echo "</td>
                <td class=\"text-left\">";
                // line 71
                echo twig_get_attribute($this->env, $this->source, $context["shirt"], "date_modified", [], "any", false, false, false, 71);
                echo "</td>
                <td class=\"text-right\">
                  <div class=\"btn-group\" style=\"min-width: 65px;\">
                    <a href=\"";
                // line 74
                echo twig_get_attribute($this->env, $this->source, $context["shirt"], "edit", [], "any", false, false, false, 74);
                echo "\" data-toggle=\"tooltip\" title=\"";
                ...
                echo "</li>
                      ";
                // line 78
                if (twig_get_attribute($this->env, $this->source, $context["shirt"], "unlock", [], "any", false, false, false, 78)) {
                    // line 79
                    echo "                      <li><a href=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["shirt"], "unlock", [], "any", false, false, false, 79);
                ...
                // line 85
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, $context["shirt"], "store", [], "any", false, false, false, 85));
...
";
    ...
    {
        return "measurement/shirt_list.twig";
    }
    ...
    {
        return new Source("", "measurement/shirt_list.twig", "");
    }
}
